...
const CategoryCreate = ({isDialogOpen, setIsDialogOpen, onSuccess}: CategoryCreateProps) => {

    const {categories, options: categoryOptions, isLoading: isCategoriesLoading} = useAllCategoryOptions();
    ...
    const {createCategory, isLoading} = useCreateCategory({
        ...
        onError: () => {
            toast.error("We couldn't create the category. Please try again.", {
                title: 'Create failed',
            });
        },
    });
