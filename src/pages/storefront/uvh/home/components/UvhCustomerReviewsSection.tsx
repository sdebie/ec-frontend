...
export function UvhCustomerReviewsSection() {
    ...
    return (
        <section
            className="relative w-full overflow-hidden bg-zinc-950 py-10 sm:py-12"
            aria-labelledby="uvh-customer-reviews-heading"
        >
            <div
                className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_75%_55%_at_90%_45%,rgba(185,28,28,0.2),transparent_60%)]"
                aria-hidden
            />
