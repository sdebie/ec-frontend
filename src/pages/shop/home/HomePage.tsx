...
import { ProductCard, CategoryCard } from '@/store/components/cards'
 ...
 * Displays hero section, featured categories, featured products, and CTAs
 */
const HomePage: React.FC<HomePageProps> = ({ activeCategory = 'All' }) => {
  ...
  // Sample categories for featured section
