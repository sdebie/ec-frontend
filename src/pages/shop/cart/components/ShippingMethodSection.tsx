    ...
    return (
        <section className="bg-white p-6 rounded-2xl shadow-sm border">
            <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                <span
                    className="bg-blue-600 text-white w-6 h-6 rounded-full text-xs flex items-center justify-center">2</span>
                Shipping Method
            </h3>
                ...
                <div className="mt-6 space-y-3 animate-in slide-in-from-top-4 duration-300">
                    ...
                    {customer && isAuthenticated && isAccountAddressEdited && (
                        <div className="mt-2 p-3 border rounded-xl bg-gray-50">
                            ...
                            <p className="text-xs text-gray-600 mt-1">If checked, your saved address will be updated in
                                your profile.</p>
                        </div>
                    )}
