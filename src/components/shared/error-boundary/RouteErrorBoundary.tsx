 ...
 *
 * Placement:
 *  - Storefront: wraps <Suspense> in StorefrontRoutes so it catches both
 *    lazy-load failures and runtime render errors inside page components.
 *  - Admin: wraps <Component> inside RouteGuard so the admin shell
 *    (header, sidebar) stays visible on a page-level crash.
 *
 * Note: React Router re-mounts children on navigation, so navigating away
 * from a crashed route and back will naturally reset the boundary. For same-
