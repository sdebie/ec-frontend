...
function StatCardSkeleton() {
  return (
    <div className="bg-(--c-panel) border border-(--c-border) p-6 rounded-xl animate-pulse">
      <div className="flex items-center gap-4">
        <div className="h-12 w-12 bg-(--c-border) rounded-lg shrink-0" />
        <div className="space-y-2 flex-1">
          <div className="h-7 w-12 bg-(--c-border) rounded" />
          <div className="h-3 w-20 bg-(--c-border) rounded" />
          <div className="h-3 w-24 bg-(--c-border) rounded" />
        </div>
      </div>
    </div>
  )
