...
export function AdminResetPasswordPage() {
    ...
    // data-surface and data-density are required, not decorative: this page renders
    // outside AdminLayout, so --c-* and --c-control-h-* (density-scoped) are otherwise
    // undefined — both are load-bearing for the shared PasswordField.
    return (
        <div
            data-surface="admin"
