    ...
    return (
        <Card as="section" variant="bordered">
            ...
            <Card.Body className="px-5 py-4">
                <div className="grid divide-y divide-(--c-border) sm:grid-flow-col sm:auto-cols-fr sm:divide-y-0 sm:divide-x">
                    <SummaryField
                        icon={Hash}
                        label="Quote ID"
                ...
                <div className="mt-4 grid divide-y divide-(--c-border) border-t border-(--c-border) pt-4 sm:grid-flow-col sm:auto-cols-fr sm:divide-y-0 sm:divide-x">
