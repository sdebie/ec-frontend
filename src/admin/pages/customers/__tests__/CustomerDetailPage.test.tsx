...
import { useWholesaleApplicationAction } from '@/admin/pages/wholesale/hooks/useWholesaleApplicationAction'
...
vi.mock('@/admin/pages/wholesale/hooks/useWholesaleApplicationAction', () => ({
