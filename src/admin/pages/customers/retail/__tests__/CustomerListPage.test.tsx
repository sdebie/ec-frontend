...
import { useCustomers } from '@/admin/pages/customers/hooks/useCustomers'
import { useUpdateCustomerStatus } from '@/admin/pages/customers/hooks/useUpdateCustomerStatus'
import { useAdminAuthStore } from '@/shared/auth/adminAuthStore'
import type { AdminCustomerSummary, CustomersPage } from '@/admin/pages/customers/types'
...
vi.mock('@/admin/pages/customers/hooks/useCustomers', () => ({
  useCustomers: vi.fn(),
}))
