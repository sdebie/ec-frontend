    ...
    <Dialog open={open} onClose={onClose} size="sm">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            {error && (
              <p
                ...
                className="text-xs text-[var(--c-danger,#ef4444)]"
                role="alert"
              >
                {error}
              </p>
      ...
      <DialogFooter>
        ...
        <Button
          ...
          isLoading={isLoading}
          className="bg-[var(--c-danger,#ef4444)] hover:bg-[var(--c-danger-hover,#dc2626)] text-[var(--c-danger-text,#fff)] focus-visible:ring-[var(--c-danger,#ef4444)]"
        >
          Reject
        </Button>
      </DialogFooter>
