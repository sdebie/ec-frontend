...
import {parseAttributes} from '@/storefront/catalog'
...
export function VariantSelector(props: VariantSelectorProps) {
    ...
    return (
        // Each attribute group is separated by a rule, so "Size" and "Colour" read
        // as distinct choices rather than one run of chips. `divide-y` puts the rule
        // BETWEEN groups only — no trailing line under the last one.
