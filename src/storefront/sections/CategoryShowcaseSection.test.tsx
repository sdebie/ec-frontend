...
describe('CategoryShowcaseSection', () => {
  ...
  it('renders product cards when products returned', () => {
    ...
    mockedUseProducts.mockReturnValue({
      products: [
        { id: 'p1', name: 'Gloves', slug: 'gloves', shortDescription: '', images: [], retailPrice: null, wholesalePrice: null, retailSalePrice: null, wholesaleSalePrice: null },
        { id: 'p2', name: 'Masks', slug: 'masks', shortDescription: '', images: [], retailPrice: null, wholesalePrice: null, retailSalePrice: null, wholesaleSalePrice: null },
      ],
      totalElements: 2,
      totalPages: 1,
      isLoading: false,
  ...
  it('renders decorative image when imageUrl provided', () => {
    ...
    const { container } = render(<CategoryShowcaseSection section={buildSection({ imageUrl: 'categories/medical.png' })} />)
