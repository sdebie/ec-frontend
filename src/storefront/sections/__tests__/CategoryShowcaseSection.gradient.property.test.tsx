...
describe('CategoryShowcaseSection configuration property', () => {
    ...
    beforeEach(() => {
        ...
        mockedUseProducts.mockReturnValue({
            products: [{id: 'product-1', name: 'Product', slug: 'product', shortDescription: '', images: [], retailPrice: null, wholesalePrice: null, retailSalePrice: null, wholesaleSalePrice: null}],
            totalElements: 1,
            totalPages: 1,
            isLoading: false,
            isError: false,
