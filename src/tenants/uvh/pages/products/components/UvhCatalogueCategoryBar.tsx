...
export function UvhCatalogueCategoryBar({categories, activeId, onSelect}: UvhCatalogueCategoryBarProps) {
    return (
        <div className="border-b border-(--sf-border) bg-(--sf-panel)">
            <div
                className="mx-auto flex max-w-7xl items-center gap-2 overflow-x-auto px-4 py-3 sm:px-6 lg:px-8 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                {categories.map((item) => {
