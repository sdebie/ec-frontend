...
// ─── UVH content types ─────────────────────────────────────────────────────────
// Tenant-specific content types and data live here so the config is the single
// source of truth for the UVH tenant.  A future CMS integration only needs to
// change this file to pull values from an API instead of static literals.
