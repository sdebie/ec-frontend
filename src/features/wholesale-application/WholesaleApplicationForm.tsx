...
import {
    ...
    type WholesaleApplicationValues,
} from '@/features/wholesale-application/schema';
import {useWholesaleApplicationSubmit} from '@/features/wholesale-application/useWholesaleApplicationSubmit';
...
export function WholesaleApplicationForm({formClassName = 'mt-6 space-y-10'}: {formClassName?: string}) {
    ...
    const {submitApplication: submitWholesaleApplication} = useWholesaleApplicationSubmit();

    const submitApplication = async (data: WholesaleApplicationValues) => {
        await submitWholesaleApplication(data);
        reset();
    };
