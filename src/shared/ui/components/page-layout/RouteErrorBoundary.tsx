...
export type RouteErrorBoundaryProps = PropsWithChildren<{
    /** URL for the "Go home" escape link — '/' for storefront routes, '/admin' for admin. @default '/' */
    homeUrl?: string
}>

/**
 * Route-level error boundary — React Router remounts children on navigation,
 * which naturally resets it;
 * same-route recovery instead uses the "Try again" button.
 */
